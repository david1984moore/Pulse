...
export const AliceMockup: React.FC = () => {
  return (
    <div className="bg-white rounded-lg overflow-hidden shadow-sm border border-gray-100">
      {/* Alice header - Exactly matching screenshot */}
      <div className="bg-blue-100 px-4 py-3 flex items-center justify-between">
        ...
        <div className="bg-blue-200 rounded-full px-3 py-1 flex items-center">
      ...
      <div className="bg-white p-4">
        ...
        {/* User's question - Blue background from screenshot */}
      ...
      <div className="border-t border-gray-200 p-3 flex items-center">
        <div className="flex-1 px-3 py-1 text-gray-400 text-sm">
          Ask Alice...
        </div>
        <button className="ml-2 bg-blue-600 text-white px-3 py-1 rounded-md text-sm font-medium" disabled>
          Send
        </button>
      </div>
    </div>
